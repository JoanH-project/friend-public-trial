...
export default function CaseForum() {
  const [cases, setCases] = useState<TrialCase[]>([]); const [ready, setReady] = useState(false); const [sort, setSort] = useState<"hot" | "new">("hot"); const [message, setMessage] = useState("");
  useEffect(() => {
